        ...
        <div class="row">
            <div class="col-12">
                ...
                <form method="post" action="<?php echo $rootdir;?>/forms/reviewofs/save.php?mode=new" name="my_form" onsubmit="return top.restoreSession()">
                    ...
                    <fieldset>
				<a class="btn btn-primary col-sm-12" data-toggle="collapse" href="#General" role="button" aria-expanded="false" aria-controls="General">
						<?php echo xlt('General')?>
					  </a>					
                    ...
                    <fieldset>
				<a class="btn btn-primary col-sm-12" data-toggle="collapse" href="#Skin" role="button" aria-expanded="false" aria-controls="Skin">
						<?php echo xlt('Skin')?>
					  </a>					
                    ...
                    <fieldset>
				<a class="btn btn-primary col-sm-12" data-toggle="collapse" href="#HEENT" role="button" aria-expanded="false" aria-controls="HEENT">
						<?php echo xlt('HEENT')?>
					  </a>					
                        <div class="collapse" id="HEENT" >							
                    ...
                    <fieldset>
				<a class="btn btn-primary col-sm-12" data-toggle="collapse" href="#Pulmonary" role="button" aria-expanded="false" aria-controls="Pulmonary">
						<?php echo xlt('Pulmonary')?>
					  </a>					
                        <div class="collapse" id="Pulmonary" >						
                    ...
                    <fieldset>
				<a class="btn btn-primary col-sm-12" data-toggle="collapse" href="#Cardiovascular" role="button" aria-expanded="false" aria-controls="Cardiovascular">
						<?php echo xlt('Cardiovascular')?>
					  </a>					
                        <div class="collapse" id="Cardiovascular" >						
                    ...
                    <fieldset>
				<a class="btn btn-primary col-sm-12" data-toggle="collapse" href="#Gastrointestinal" role="button" aria-expanded="false" aria-controls="Gastrointestinal">
						<?php echo xlt('Gastrointestinal')?>
					  </a>					
                        <div class="collapse" id="Gastrointestinal" >							
                    ...
                    <fieldset>
				<a class="btn btn-primary col-sm-12" data-toggle="collapse" href="#Genitourinary" role="button" aria-expanded="false" aria-controls="Genitourinary">
						<?php echo xlt('Genitourinary')?>
					  </a>					
                        <div class="collapse" id="Genitourinary" >						
                    ...
                    <fieldset>
				<a class="btn btn-primary col-sm-12" data-toggle="collapse" href="#Musculoskeletal" role="button" aria-expanded="false" aria-controls="Musculoskeletal">
						<?php echo xlt('Musculoskeletal')?>
					  </a>					
                        <div class="collapse" id="Musculoskeletal" >						
                    ...
                    <fieldset>
				<a class="btn btn-primary col-sm-12" data-toggle="collapse" href="#Endocrine" role="button" aria-expanded="false" aria-controls="Endocrine">
						<?php echo xlt('Endocrine')?>
					  </a>					
                        <div class="collapse" id="Endocrine" >					
                    ...
                    <fieldset>
				<a class="btn btn-primary col-sm-12" data-toggle="collapse" href="#Additional" role="button" aria-expanded="false" aria-controls="Additional">
						<?php echo xlt('Additional Notes')?>
					  </a>					
