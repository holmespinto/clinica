...
<head>
    ...
    <script>
        ...
        $i = 0;
        foreach ($ISSUE_TYPES as $key => $value) {
            echo " aitypes[" . attr($i) . "] = " . js_escape($value[0]) . ";\n";
                    ...
                    <form class="form-horizontal" name='theform' method="post" onsubmit='return validate()'>
                        ...
                        <div class="form-group col-12" id='row_titles'>
                            <label for="form_titles" class="col-form-label"> </label>
								<select class="js-example-data-ajax form-control" id="<?php echo $_REQUEST["thistype"]; ?>" name="<?php echo $_REQUEST["thistype"]; ?>">
								  <option value="0">INCIDENCIA</option>
								  </select> 
<script>								  
$('#<?php echo $_REQUEST["thistype"]; ?>').select2({
    ...
    var text = $("#<?php echo $_REQUEST['thistype']; ?> option:selected").text();
    var values = $("#<?php echo $_REQUEST['thistype']; ?> option:selected").val();
				
				 $("#form_title").val(text);	
				 $("#form_title_id").val(values);	
                        ...
                        <div class="form-group col-12">
                            ...
                            <input type='hidden' name='form_title_id' value=''>
                        </div>
                        <div class="form-group col-12">
                        ...
                        <div class="form-group col-12" id='row_destination'>
                            <label class="col-form-label" for="form_destination"><?php echo xlt('Destination'); ?>:</label>
                            <?php if (true) { ?>
                                <input type='hidden' class='form-control' name='form_destination' id='form_destination' value='<?php echo attr($irow['destination'] ?? '') ?>' style='width:100%' title='GP, Secondary care specialist, etc.' />
