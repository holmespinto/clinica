        ...
        <div class="row">
            <div class="col-sm-12">
                <form action='new_comprehensive_save.php' name='demographics_form' id="DEM"  method='post' onsubmit='return submitme(<?php echo $GLOBALS['new_validate'] ? 1 : 0;?>,event,"DEM",constraints)'>
                  ...
                  // Handle a data category (group) change. layout_group_properties
                        if (strcmp($this_group, $last_group) != 0) {
                            if (!$SHORT_FORM) {
								...
								if(($group_seq==5)or($group_seq==3)or($group_seq==6)){
									echo "<span class='font-weight-bold'><strong></strong></span>\n";
									...
									echo " /><strong>" .$group_seq.'-'.text(xl_layout_label($group_name)) . "</strong></span>\n";
									echo "<div id='div_" . attr($group_seq) . "' class='section' style='display: $display_style;'>\n";
									echo " <table class='table table-borderless form-inline'>\n";
									$display_style = 'none';
									}	
                      ...
                      // Handle starting of a new label cell.
                        ...
                        echo "<strong>&nbsp;&nbsp;&nbsp;";
                        echo (text(xl_layout_label($frow['description'])) . ":&nbsp;");
                        echo "</strong>";
...
$(function () {
    ...
    var check = function(e) {
        ...
        $mfres = sqlStatement("SELECT * FROM layout_options " .
            "WHERE form_id = 'DEM' AND group_id IN (1,2,4,8) AND uor >0 AND" .
            "(edit_options LIKE '%D%')" .
            "ORDER BY group_id, seq");
